[ { name: 'Metro Center', code: 'A01' },
  ...
  { name: 'Woodley Park-Zoo/Adams Morgan', code: 'A04' },
  { name: 'Cleveland Park', code: 'A05' },
  { name: 'Van Ness-UDC', code: 'A06' },
  { name: 'Tenleytown-AU', code: 'A07' },
  ...
  { name: 'King St-Old Town', code: 'C13' },
  ...
  { name: 'Potomac Ave', code: 'D07' },
  { name: 'Stadium-Armory', code: 'D08' },
  { name: 'Minnesota Ave', code: 'D09' },
  { name: 'Deanwood', code: 'D10' },
  { name: 'Cheverly', code: 'D11' },
  { name: 'Landover', code: 'D12' },
  { name: 'New Carrollton', code: 'D13' },
  { name: 'Mt Vernon Sq 7th St-Convention Center', code: 'E01' },
  { name: 'Shaw-Howard U', code: 'E02' },
  { name: 'U Street/African-Amer Civil War Memorial/Cardozo',
    code: 'E03' },
  { name: 'Columbia Heights', code: 'E04' },
  { name: 'Georgia Ave-Petworth', code: 'E05' },
  { name: 'Fort Totten', code: 'E06' },
  { name: 'West Hyattsville', code: 'E07' },
  { name: 'Prince George\'s Plaza', code: 'E08' },
  { name: 'College Park-U of MD', code: 'E09' },
  { name: 'Greenbelt', code: 'E10' },
  { name: 'Gallery Pl-Chinatown', code: 'F01' },
  { name: 'Archives-Navy Memorial-Penn Quarter', code: 'F02' },
  ...
  { name: 'Branch Ave', code: 'F11' },
  { name: 'Benning Road', code: 'G01' },
  { name: 'Capitol Heights', code: 'G02' },
  { name: 'Addison Road-Seat Pleasant', code: 'G03' },
  ...
  { name: 'Virginia Square-GMU', code: 'K03' },
  { name: 'Ballston-MU', code: 'K04' },
  { name: 'East Falls Church', code: 'K05' },
  { name: 'West Falls Church-VT/UVA', code: 'K06' },
  { name: 'Dunn Loring-Merrifield', code: 'K07' },
  { name: 'Vienna/Fairfax-GMU', code: 'K08' },
  { name: 'McLean', code: 'N01' },
  { name: 'Tysons Corner', code: 'N02' },
  { name: 'Greensboro', code: 'N03' },
  { name: 'Spring Hill', code: 'N04' },
